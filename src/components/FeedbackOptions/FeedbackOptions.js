...
<ul className={css.buttons__list}>
    ...
    <li className={css.button}><button type="button" onClick={handlerNeutralBtn}>Neutral</button></li>
    <li className={css.button}><button type="button" onClick={handlerBadBtn}>Bad</button></li>
</ul>
